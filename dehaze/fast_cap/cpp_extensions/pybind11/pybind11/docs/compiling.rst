...
PyPI integration, can be found in the [crane]_  repository.

.. [crane] https://github.com/pybind/crane
...
can refer to the same [crane]_ repository for a full sample project

...
void seamless_cloning_demo() {
    // 读取图像
    std::string input_dir("../../../editing/possion_image_editing/images/edit/3/");
    ...
    // 其它经典例子
    input_dir = "../../../editing/possion_image_editing/images/edit/1/";
    ...
    input_dir = "../../../editing/possion_image_editing/images/edit/4/";
    ...
    /* 这个例子会报错, 应该是线性方程组无解
    input_dir = "../../../editing/possion_image_editing/images/edit/2/";
    ...
    */
    ...
    input_dir = "../../../editing/possion_image_editing/images/edit/5/";
    ...
    input_dir = "../../../editing/possion_image_editing/images/edit/6/";
    ...
    input_dir = "../../../editing/possion_image_editing/images/edit/7/";
    ...
    input_dir = "../../../editing/possion_image_editing/images/edit/8/";
    ...
    input_dir = "../../../editing/possion_image_editing/images/edit/9/";
    ...
    input_dir = "../../../editing/possion_image_editing/images/edit/14/";
...
void possion_edit_demo_1() {
    // 读取图像
    std::string input_dir("../../../editing/possion_image_editing/images/edit/10/");
...
void possion_texture_flatten_demo() {
    // 读取图像
    std::string input_dir("../../../editing/possion_image_editing/images/edit/11/");
...
void possion_content_flip_demo() {
        // 读取图像
    std::string input_dir("../../../editing/possion_image_editing/images/edit/13/");
...
void seam_clone_demo() {
    std::string input_dir = "../../../editing/possion_image_editing/images/edit/14/";
...
void possion_texture_transform_demo() {
    std::string input_dir = "../../../editing/possion_image_editing/images/edit/17/";
...
void possion_illumination_change_demo() {
    std::string input_dir = "../../../editing/possion_image_editing/images/edit/16/";
